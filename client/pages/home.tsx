...
import { FlatList, SafeAreaView, StatusBar, StyleSheet, Text, TouchableOpacity, View, Image, Button } from 'react-native';
      ...
      <View style={ styles.itemHeaderAvatar }>
        ...
        <Text>{ item.userName }</Text>
			...
			<View>
				...
				<Text style={{color: '#9D9D9D' }} >{ item.discussTimes }個討論 {item.sharedTimes}個分享</Text>
			</View>
		</View>
		<Image
